	...
	<div id="cloud">
		<div class="login">
			...
			<div class="loginContent">
				<form class="content" action="<%=request.getContextPath()%>/user/getlogin" method="post"
					...
					<div class="loginBottom">
						<ul>
							...
							<li><a href="<%=request.getContextPath()%>/user/Register"><input type="button" value="立即注册"></a></li>
						</ul>
					</div>
				</form>
			</div>
